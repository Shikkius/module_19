...
def results(res):
    """Функция для возврата статуса. Сокращение кода"""
...
class PetFriends:
    ...
    def add_new_pet(self, auth_key: json, name: str, animal_type: str, age: int, pet_photo: str) -> json:
        """Метод постит (POST) на сервер данны о добавляемом питомце и возвращает статус запроса на сервер
        и результат в форрмате JSON с данными добавленного питомца"""
    ...
    def delete_pet(self, auth_key: json, pet_id: str) -> json:
        """Метод отправляет на сервер запрос на удаление питомца по указанному ID
         ...
         Имеется баг: в result приходит пустая строка, но status при этом = 200"""
